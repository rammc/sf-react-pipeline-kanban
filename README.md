...
See [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) for a Mermaid
component-and-data-flow diagram plus the load-bearing design
decisions (manual types vs codegen, client-side filtering, optimistic
update pattern, why zustand for one piece of state).
